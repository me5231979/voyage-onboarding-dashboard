...
const VOYAGE = {
  ...
  items: [
    ...
    { id: 'ferpa', type: 'course',     title: 'FERPA Tutorial', cat: 'compliance', lane: 'w1', mins: 15, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 10', href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300001262145866' },
    ...
    { id: 'handbook', type: 'read',  title: 'Staff handbook — the essentials', cat: 'policies', lane: 'w1', mins: 30, src: 'SharePoint', api: false, due: 'soft', dueLabel: 'Day 14', href: 'https://hr.vanderbilt.edu/policies/' },
    ...
    /* ---- Role-driven ---- */
    { id: 'mgr-safety', type: 'course',title: 'Manager safety obligations & incident reporting', cat: 'safety', lane: 'w24', mins: 25, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 21', aud: { role: ['manager'] }, href: 'https://hr.vanderbilt.edu/policies/' },
    { id: 'mgr-comp', type: 'course',  title: 'Leading at VU — Compliance & Supervisory Fundamentals', cat: 'compliance', lane: 'w24', mins: 30, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 21', aud: { role: ['manager'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300002258801629' },
    ...
    { id: 'infection', type: 'course', title: 'Bloodborne Pathogen Awareness 2.0', cat: 'safety', lane: 'w1', mins: 30, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 7', aud: { role: ['clinical'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300001633833959' },
    ...
    { id: 'labsafety', type: 'course', title: 'Laboratory Safety', cat: 'safety', lane: 'w1', mins: 40, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 7', aud: { role: ['research'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300001633958517' },
    { id: 'biosafety', type: 'course', title: 'Biosafety 101 — Standard Microbiological Practices (VU EHS)', cat: 'safety', lane: 'w24', mins: 45, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 21', aud: { role: ['research'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300002424826840' },
    { id: 'irb', type: 'course',       title: 'IRB Basics Course', cat: 'compliance', lane: 'w24', mins: 45, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 21', aud: { role: ['research'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300001523737433' },
    { id: 'export', type: 'course',    title: 'Global Export Compliance', cat: 'compliance', lane: 'w24', mins: 20, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 30', aud: { role: ['research'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300002733138581' },
    ...
    { id: 'minors', type: 'course',    title: 'Protection of Minors 101', cat: 'compliance', lane: 'w24', mins: 60, src: 'Oracle Learn', api: true, due: 'hard', dueLabel: 'Day 30', aud: { role: ['student'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300001392072066' },
    { id: 'clery', type: 'course',     title: 'Clery Act 2025', cat: 'compliance', lane: 'w24', mins: 25, src: 'Oracle Learn', api: true, due: 'soft', dueLabel: 'Day 30', aud: { role: ['student'] }, href: 'https://ecsr.fa.us2.oraclecloud.com/fscmUI/redwood/learner/learn/redirect?learningItemType=ORA_COURSE&learningItemId=300002941776929' },
  ...
  tiles: [
    ...
    { id: 'benefits', type: 'task',   label: 'Benefits', cats: ['benefits'] },
